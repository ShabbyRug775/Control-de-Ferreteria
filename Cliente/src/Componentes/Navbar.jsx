  ...
  return (
    <nav className="bg-zinc-700 my-3 flex justify-between py-5 px-10 rounded-lg">
      <h1 className="text-2xl font-bold">
        <Link to={isAuthenticated ? "/ArticulosPage" : "/"}> Administrador de articulos </Link>
      </h1>
      <ul className="flex gap-x-2">
        {isAuthenticated ? (
          <>
            ...
            <li>
              <ButtonLink to="/ArticulosForm"> Añadir articulo </ButtonLink>
            </li>
            <li>
              <ButtonLink to="/articulos"> Articulo </ButtonLink>
            </li>
            <li>
